...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
		...
		Schema::table('notifications', function(Blueprint $table) {
			$table->foreign('donation_request_id')->references('id')->on('donation_request')
						->onDelete('no action')
						->onUpdate('no action');
		});
	...
	public function down()
	{
		...
		Schema::table('donation_request', function(Blueprint $table) {
			$table->dropForeign('donation_request_city_id_foreign');
		});
		Schema::table('donation_request', function(Blueprint $table) {
			$table->dropForeign('donation_request_blood_type_id_foreign');
		});
		Schema::table('donation_request', function(Blueprint $table) {
			$table->dropForeign('donation_request_client_id_foreign');
		});
		Schema::table('notifications', function(Blueprint $table) {
